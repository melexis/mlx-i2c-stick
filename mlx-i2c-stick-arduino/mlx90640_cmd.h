...
void cmd_90640_ee(uint8_t sa, uint16_t *ee_data, uint16_t *ee_count, uint16_t *ee_start_address, char const **error_message);

void mlx90640_show_calibration_parameters(uint8_t sa);
